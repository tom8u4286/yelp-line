...
print 'avg_word_count_pre_review: ',float(avg_word_count_pre_review)/265
print 'avg_menu_length: ',float(avg_menu_length)/265
print 'avg_senti_per_review: ',float(avg_senti_per_review)/265
print 'dish_senti_avg_length: ',float(dish_senti_avg_length)/265
